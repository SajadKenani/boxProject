        ...
        <div >
          ...
          <div className="flex justify-center">
            ...
            <div className="bg-white grid lg:flex justify-between p-10 " style={{paddingLeft: myPadding+"%", paddingRight:  myPadding+"%"}}>
              ...
              <a href="sms:+9647858002915?&body=" className="p-5 pt-0 pb-0 -m-3 mt-0 lg:m-5 sm:m-0">
               <img style={{ height: "56px", cursor: "pointer" }}  src={phonecall_Icon} alt="Email Agent" />
              </a>
              <a href="mailto:inboxcomp@hotmail.com?subject=From%20InBox%20Website" className=" p-5 pt-0 pb-0 -m-3 mt-0 lg:m-5 sm:m-0">
